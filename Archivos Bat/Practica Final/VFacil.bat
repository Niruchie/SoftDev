...
echo Puntuacion: %acumula% Vidas: %contador%
echo.
echo 2) Cuantas patas tiene la arania?
echo.
echo ************************
echo *    1)8               *
echo *    2)45              *
...
echo ************************
set/p op5=
if %op5% == 1 (set/a acumula = %acumula%+100) else (set/a contador = %contador%-1)
If %contador% EQU 0 goto Fin
pause>nul
cls
echo Puntuacion: %acumula% Vidas: %contador%
...
echo Puntuacion: %acumula% Vidas: %contador%
echo.
echo 8) Cual de los siguientes numeros no es primo?
echo.
echo ************************
echo *    1)11              *
echo *    2)45              *
